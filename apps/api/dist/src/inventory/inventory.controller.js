...
let InventoryController = class InventoryController {
    ...
    updateInventoryItem(id, data, req) {
...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)('EXECUTIVE', 'PROCUREMENT', 'ADMIN'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [inventory_dto_1.CreateInventoryItemDto, Object]),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)('EXECUTIVE', 'PROCUREMENT', 'ADMIN', 'CLINICIAN'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, inventory_dto_1.UpdateInventoryItemDto, Object]),
    __metadata("design:returntype", void 0)
