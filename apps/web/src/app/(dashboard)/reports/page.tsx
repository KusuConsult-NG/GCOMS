    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="clinical-card">
          <span className="text-xs font-semibold text-[var(--muted)] uppercase tracking-wide">Total Community Reach</span>
          <p className="text-3xl font-bold text-[var(--primary)] mt-1 tabular-nums">1,845</p>
        </div>
        <div className="clinical-card">
          <span className="text-xs font-semibold text-[var(--muted)] uppercase tracking-wide">Screenings Conducted</span>
          <p className="text-3xl font-bold text-[var(--secondary)] mt-1 tabular-nums">{summary?.totalScreenings || 462}</p>
        </div>
        <div className="clinical-card">
          <span className="text-xs font-semibold text-[var(--muted)] uppercase tracking-wide">Under Care Navigation</span>
          <p className="text-3xl font-bold text-[var(--risk-mod-text)] mt-1 tabular-nums">184</p>
        </div>
        <div className="clinical-card">
          <span className="text-xs font-semibold text-[var(--muted)] uppercase tracking-wide">Hospital Referrals</span>
          <p className="text-3xl font-bold text-[var(--risk-low-text)] mt-1 tabular-nums">51</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg border border-[var(--outline)] p-5 space-y-4">
          ...
          <div className="space-y-3 text-xs font-medium text-[var(--on-background)]">
            ...
            <div>
              ...
              <div className="w-full bg-[var(--surface-subtle)] h-2 rounded-full overflow-hidden">
                <div className="bg-[var(--secondary)] h-full rounded-full w-[25%]"></div>
              </div>
            </div>
            <div>
              <div className="flex justify-between mb-1">
              ...
              <div className="w-full bg-[var(--surface-subtle)] h-2 rounded-full overflow-hidden">
                <div className="bg-[var(--risk-mod-text)] h-full rounded-full w-[10%]"></div>
              </div>
            </div>
            <div>
              <div className="flex justify-between mb-1">
              ...
              <div className="w-full bg-[var(--surface-subtle)] h-2 rounded-full overflow-hidden">
                <div className="bg-[var(--risk-low-text)] h-full rounded-full w-[5%]"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-[var(--outline)] p-5 space-y-4">
          ...
          <div className="space-y-2 text-xs">
            <div className="p-3 rounded bg-[var(--background)] border border-[var(--outline)] flex justify-between items-center">
              <div>
                <p className="font-bold text-[var(--primary)]">Q1 Community Health Impact & Screening Audit</p>
            ...
            <div className="p-3 rounded bg-[var(--background)] border border-[var(--outline)] flex justify-between items-center">
              <div>
                <p className="font-bold text-[var(--primary)]">Barkin Ladi & Jos South Field Audit</p>
